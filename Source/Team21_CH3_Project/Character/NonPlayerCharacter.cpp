...
void ANonPlayerCharacter::BeginPlay()
{
	...
	if (false == IsPlayerControlled())
	{
		...
		GetCapsuleComponent()->OnComponentBeginOverlap.AddDynamic(this, &ANonPlayerCharacter::OnBossCapsuleOverlap);
	}
}
...
void ANonPlayerCharacter::OnBossCapsuleOverlap(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
